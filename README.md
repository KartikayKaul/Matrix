...
## Updates
- (commit update timestamp: 101620250157). I am thinking of implementing a memory pool allocator that will get a chunk of memory for each DATA type from stack and that will be used to allocate memory and deallocate memory for *val pointer inside the mempool object. I am occassionally working on this and will test it and release it. 
